Planet_Lab_v33_withJ2_Neptune.py requires Planet_Lab_v33_fnc.py, calculate_J2.py file, the various cms functions, and the hydrogen equation of state table. Planet_Lab_v33_withJ2.py is similar, but setup for general use.  The accuracy of the cms run at the end of the model depends on settings for grid resolution.  
